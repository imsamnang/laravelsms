...
@foreach ($readStudentFee as $key => $sf)
					...
					<tr data-id="" id="sfeedid">
						...
						<td style="text-align: center; width: 115px;">
							...
							<button type="button" class="btn btn-danger btn-xs btn-paid" value="{{ $sf->student_amount - $readStudentTransact->where('s_fee_id',$sf->s_fee_id)->sum('paid'),2 }}" data-id="{{ $sf->s_fee_id }}">
